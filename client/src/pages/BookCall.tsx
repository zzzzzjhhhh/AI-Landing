                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Jane" {...field} className="h-12 bg-navy-900/50 backdrop-blur-md border-white/10 text-white placeholder:text-white/10 focus:border-white focus:ring-0 transition-colors rounded-xl" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Doe" {...field} className="h-12 bg-navy-900/50 backdrop-blur-md border-white/10 text-white placeholder:text-white/10 focus:border-white focus:ring-0 transition-colors rounded-xl" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="email" placeholder="jane@company.com" {...field} className="h-12 bg-navy-900/50 backdrop-blur-md border-white/10 text-white placeholder:text-white/10 focus:border-white focus:ring-0 transition-colors rounded-xl" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Acme AI" {...field} className="h-12 bg-navy-900/50 backdrop-blur-md border-white/10 text-white placeholder:text-white/10 focus:border-white focus:ring-0 transition-colors rounded-xl" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                 ...
                 <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="+1 (555) 000-0000" {...field} value={field.value || ''} className="h-12 bg-navy-900/50 backdrop-blur-md border-white/10 text-white placeholder:text-white/10 focus:border-white focus:ring-0 transition-colors rounded-xl" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea 
                        ...
                        className="bg-navy-900/50 backdrop-blur-md border-white/10 text-white placeholder:text-white/10 min-h-[120px] focus:border-white focus:ring-0 transition-colors resize-none rounded-xl p-4" 
                        {...field} 
                        value={field.value || ''}
                      />
                    </FormControl>
