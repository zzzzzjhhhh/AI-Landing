                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Jane" {...field} className="h-12 bg-transparent border-0 border-b border-white/30 text-white placeholder:text-white/20 focus-visible:ring-0 focus-visible:border-white focus-visible:outline-none focus:ring-0 focus:outline-none ring-0 outline-none shadow-none transition-colors rounded-none px-0" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea 
                        ...
                        className="bg-transparent border-0 border-b border-white/30 text-white placeholder:text-white/20 min-h-[120px] focus-visible:ring-0 focus-visible:border-white focus-visible:outline-none focus:ring-0 focus:outline-none ring-0 outline-none shadow-none transition-colors resize-none rounded-none px-0 py-4" 
                        {...field} 
                        value={field.value || ''}
                      />
                    </FormControl>
