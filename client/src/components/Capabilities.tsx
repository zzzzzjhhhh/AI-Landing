          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {capabilities.map((cap, index) => (
              <motion.div
                ...
                className="group relative p-6 rounded-2xl bg-navy-900 border border-white/5 hover:border-blue-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-900/10"
              >
                ...
                <h3 className="text-xl font-display font-bold text-white mb-2">{cap.title}</h3>
