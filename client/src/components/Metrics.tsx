...
function Counter({ from, to, suffix = "" }: { from: number; to: number; suffix?: string }) {
  ...
  return (
    <span ref={ref} className="text-5xl md:text-6xl lg:text-7xl font-display text-white font-normal tracking-tighter">
      ...
      <span className="text-[#3a7e91]">{suffix}</span>
    </span>
  );
}
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-16">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-16 gap-x-8 text-center mb-20">
          <div>
            ...
            <p className="font-medium uppercase tracking-widest text-xs text-[#3a7e91]">Labels Delivered</p>
          </div>
          <div>
            <div className="mb-2">
              <Counter from={0} to={99} suffix=".7%" />
            </div>
            <p className="font-medium uppercase tracking-widest text-xs text-[#3a7e91]">QA Pass Rate</p>
          </div>
          <div>
            <div className="mb-2">
              <Counter from={0} to={500} suffix="+" />
            </div>
            <p className="font-medium uppercase tracking-widest text-xs text-[#3a7e91]">Domain Experts</p>
          </div>
          <div>
            <div className="mb-2">
              <Counter from={0} to={40} suffix="%" />
            </div>
            <p className="font-medium uppercase tracking-widest text-xs text-[#3a7e91]">Faster Turnaround</p>
          </div>
        </div>
      </div>
