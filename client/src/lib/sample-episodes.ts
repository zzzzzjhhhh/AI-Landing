...
export const sampleEpisodes: readonly SampleEpisode[] = [
  ...
  },
  {
    ...
    flexionTitle: "Right-hand flexion from accepted stereo tracking.",
    flexionNote: "Stereo left/right keypoints use the accepted left V5 and right V4 tracking. Movement retargets their stereo/MANO 3D fit to the original WebHand rig, with 120 ms local quaternion smoothing and 30 fps playback. This is model-estimated motion, not ground truth. Pressure retains the reviewed contact data and shared 0/22/44 display unchanged.",
