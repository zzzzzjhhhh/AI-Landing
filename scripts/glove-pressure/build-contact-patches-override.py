...
try:
 for line in process.stdout:
  ...
  recording.log(entity+'/status',rr.Points3D([[-.45,-2.65,.9]],radii=0,colors=[180,213,222,255],labels=[f"V3 {row['state']} | 0.5s visual estimate, not force"],show_labels=True))
  ...
  count+=1
  last=t
  if count%500==0:print(f'[RUNNING] V3 overlay {count}/2920',flush=True)
